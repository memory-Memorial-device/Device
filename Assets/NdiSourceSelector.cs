...
sealed class NdiSourceSelector : MonoBehaviour
{
        ...
        bool IsOpened
          => _dropdown.transform.childCount > 3;
        ...
        void Update()
        {
            // Do nothing if the dropdown is not visible.
            if (!_dropdown.gameObject.activeSelf) return;
